...
//    Exercise("squats", R.drawable.squat, "Squats", time = 50, prepareTime = 8), // M
    ...
    Exercise("neck_rotation", R.drawable.neck_rotation, "Neck Rotation", time = 15),
...
//    Exercise("pull_ups", R.drawable.pull_ups, "Close Grip Pull Ups", time = 25, prepareTime = 8) // H
)
...
//    Exercise("standing_hamstring_stretch", R.drawable.standing_hamstring_stretch, "Standing Hamstring Stretch", sides = listOf("right", "left"), p = 0.4),
    ...
    Exercise("upper_trap_stretch_front", R.drawable.upper_trap_stretch, "Upper Trap Front Stretch", sides = listOf("right", "left"), time = 15, switchSidesTime = 0, p = 0.4),
    Exercise("upper_trap_stretch_back", R.drawable.upper_trap_stretch, "Upper Trap Back Stretch", sides = listOf("right", "left"), time = 15, switchSidesTime = 0, p = 0.4)
)
